...
1. A **raw gene-by-cell counts matrix** (sparse `dgCMatrix`, `RDS`, or `MTX triplet` file).
   
2. A **marker configuration** — a structured list of broad and fine cell type marker genes.
